...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ckud76d', 'template_sgkw7br', form.current, 'aba422ca6ab0db5ef5e4a514534b5d18')
      .then((result) => {
    ...
    return (
       <section className='contact section' id='contact'>
        <h2 className='section__title'>Get in tuch</h2>
        ...
        <div className='contact__container container grid'>
            ...
            <div className='contact__content'>
                <h2 className='contact__title'>Write to me your project</h2>
